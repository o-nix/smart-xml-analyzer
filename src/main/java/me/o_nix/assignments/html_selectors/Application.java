package me.o_nix.assignments.html_selectors;
...
import me.o_nix.assignments.html_selectors.processing.HtmlInspectionService;
import me.o_nix.assignments.html_selectors.processing.OriginDataPieceComparator;
import me.o_nix.assignments.html_selectors.processing.Processor;

import java.nio.file.Files;
import java.nio.file.Path;
import java.nio.file.Paths;

import static me.o_nix.assignments.html_selectors.utils.Assert.assertTrue;
  ...
  private static Processor createProcessor(String[] args) {
    ...
    ImmutableMap.Builder<String, OriginDataPieceComparator> comparatorsBuilder =
        ImmutableMap.<String, OriginDataPieceComparator>builder()
            .put(HtmlInspectionService.DUMMY_STRATEGY_NAME, new OriginDataPieceComparator(1));
